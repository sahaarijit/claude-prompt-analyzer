...
> **Note:** This is the frozen v1.0 release branch. The latest version is [v2.0.0](https://github.com/sahaarijit/claude-prompt-analyzer).
...
Every prompt you type in Claude Code is silently logged per project, organized by day.
...
Each analysis tracks cumulative scores, streaks, and milestones.
...
Then restart Claude Code. The hook and skill are installed automatically into `~/.claude/`.
...
|---|---|
| `/prompt-analyze` | Analyze today's prompts; shows scored report |
